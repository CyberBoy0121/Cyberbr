...
echo -e "$Green Created By \e[1;34m"
       figlet Cyber Boy | lolcat
sleep 2.0

    echo " "
    echo -e "$Red                               ⫸ Coded by$Yellow Cyber Boy$Red ⫷\033[0m"
    echo -e "$Red                               ⫸$Red website under maintenance ;) $Red ⫷\033[0m"
echo " "
...
echo -e " $Red       ||             $Purple%=>$Yellow[6️⃣] Update Cyberbr$Blue                        ||"
echo -e " $Red       ||             $Purple%=>$Yellow[7️⃣] About Cyber Boy$Blue                       ||"
